...
| /live/clip/set/notes                     | track_id, clip_id, pitch, start_time, duration, velocity, mute, ... |                                                                                        | Replace existing notes in a clip with the supplied note list. Same pitch/time semantics as add/remove.                                                     |
